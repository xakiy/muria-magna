...
Policy_Config = {
    ...
    "routes": {
        ...
        "/v1/orang": {"OPTIONS": ["@passthrough"], "GET": ["reader"]},
        "/v1/orang/{id:uuid}": {
            "OPTIONS": ["@passthrough"],
            "GET": ["reader"],
            "POST": ["creator"],
        ...
        "/v1/santri": {"OPTIONS": ["@passthrough"], "GET": ["reader"]},
        "/v1/santri/{id:uuid}": {
            "OPTIONS": ["@passthrough"],
            "GET": ["reader"],
            "POST": ["creator"],
        ...
        "/v1/stats/orang": {"OPTIONS": ["@passthrough"], "GET": ["reader"]},
        "/v1/stats/wali": {"OPTIONS": ["@passthrough"], "GET": ["reader"]},
        "/v1/stats/santri": {"OPTIONS": ["@passthrough"], "GET": ["@passthrough"]},
        "/v1/stats/santri/{jinshi}": {
            "OPTIONS": ["@passthrough"],
            "GET": ["@passthrough"],
        },
        "/v1/upload": {"OPTIONS": ["@passthrough"], "POST": ["@passthrough"]},
        "/v1/images": {"OPTIONS": ["@passthrough"], "GET": ["@passthrough"]},
        "/v1/images/{name}": {
            "OPTIONS": ["@passthrough"],
            "GET": ["@passthrough"],
            "POST": ["@passthrough"],
